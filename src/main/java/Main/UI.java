...
//        objectlabel.setBackground(Color.blue);
    ...
    private void createPlayerField() {
        ...
        ImageIcon lifeIcon = new ImageIcon(getClass().getResource("/images/heart 35x35.png"));
        ...
        ImageIcon swordIcon = new ImageIcon(getClass().getResource("/images/plain-dagger.png"));
        ...
        ImageIcon shieldIcon = new ImageIcon(getClass().getResource("/images/round-shield.png"));
        ...
        ImageIcon lanternIcon = new ImageIcon(getClass().getResource("/images/lantern-flame.png"));
    ...
    public void generateScene() {
        //SCENE 1
        createBackground(1, "/images/christmas-background.png");
        createObject(1, 430, 100, 215, 200, "/images/hut3.png", "Look", "Talk", "Rest", "lookHut", "talkHut", "restHut");
//        createObject(1, 230, 130, 150, 150, "Character2.png");
        createObject(1, 250, 230, 150, 150, "/images/Character1.png", "Look", "Talk", "Attack", "lookNPC", "talkNPC", "attackNPC");
        createArrowButton(1, 4, 110, 50, 50, "/images/leftArrow.png", "goScene2");
        createArrowButton(1, 586, 110, 50, 50, "/images/rightArrow.png", "goScene3");
        bgPanel[1].add(bgLabel[1]);

        //SCENE 2
        createBackground(2, "/images/snowCave.png");

        createObject(2, 150, 0, 360, 50, "/images/starSky.png", "Look", "", "", "lookStars", "", "");

        createObject(2, 330, 200, 100, 100, "/images/signSnow.png", "Read", "", "", "readSnowSign", "", "");

        createObject(2, 60, 250, 100, 100, "/images/chest.png", "Look", "Talk", "Loot", "lookChest", "talkChest", "openChest");

//        createObject(2, 70, 130, 160, 160, "/images/Empty2.png", "Look", "Talk", "Enter", "lookCave", "talkCave", "enterCave");

        createObject(2, 50, 85, 215, 200, "/images/snowHouse.png", "Look", "Talk", "Enter", "lookCave", "talkCave", "enterCave");

        createArrowButton(2, 646, 110, 50, 50, "/images/rightArrow.png", "goScene1");
        bgPanel[2].add(bgLabel[2]);

        //SCENE 3
        createBackground(3, "/images/cave-inside.png");
        createArrowButton(3, 650, 150, 50, 50, "/images/rightArrow.png", "goScene2");
